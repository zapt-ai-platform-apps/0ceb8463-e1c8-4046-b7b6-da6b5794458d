...
3. **خدمة بيع التطبيقات:**
   ...
   - يمكن للمستخدمين الاطلاع على باقات خدمات تطوير وبيع التطبيقات.
   - الباقات المتاحة:
...
2. **استكشاف الخدمات:**
   ...
   - اضغط على زر **"خدمة بيع التطبيقات"** لاستعراض الباقات المتاحة.

3. **عرض الباقات:**

   - ستظهر قائمة الباقات المتاحة مع تفاصيل كل باقة.
